...
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\AdaptivelyMTL')
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\dmtl')
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\scmtl')
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\mcnn_aux')
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\ResNet50_HAN_HU')
sys.path.append('C:\\Users\\CSR\\Desktop\\scmtl_extended_experiment\\Duke_experiment\\stl')
sys.path.append('.')
...
root_dir = 'J:\\DukeMTMC-attribute-master\\Duke'
label_dir = 'J:\\DukeMTMC-attribute-master\\Duke_label'

#todo_list = [('Black_Hair','Wavy_Hair'), ('Black_Hair', 'Straight_Hair'), ('Blond_Hair', 'Wavy_Hair'), ('Blond_Hair', 'Straight_Hair'), ('Brown_Hair', 'Wavy_Hair'), ('Brown_Hair', 'Straight_Hair'), ('Smiling', 'Goatee'), ('Smiling', 'Wearing_Lipstick'), ('Mouth_Slightly_Open', 'Goatee'), ('Mouth_Slightly_Open', 'Wearing_Lipstick'), ('Smiling', 'Black_Hair'), ('Smiling', 'Wavy_Hair'), ('Smiling', 'Straight_Hair')]

#todo_list = [('Blond_Hair', 'Wavy_Hair'), ('Blond_Hair', 'Straight_Hair'), ('Brown_Hair', 'Wavy_Hair'), ('Brown_Hair', 'Straight_Hair')]

#todo_list = [('Black_Hair','Wavy_Hair')]

#todo_list = [('Black_Hair','Wavy_Hair'), ('Black_Hair', 'Straight_Hair'), ('Blond_Hair', 'Wavy_Hair'), ('Blond_Hair', 'Straight_Hair'), ('Brown_Hair', 'Wavy_Hair'), ('Brown_Hair', 'Straight_Hair')]

todo_list = [('boots','hat'), ('boots', 'upblack'), ('boots', 'downblue'), ('boots', 'downblack'), ('hat', 'upblack'), ('hat', 'downblue'), ('hat', 'downblack')]
...
for task_list in todo_list:
    ...
    batch_size = 64
    train_set = ReadData.DukeSpecializedDataset(root_dir, label_dir, task_list[0], task_list[1], 'train', data_transform)
    train_dataloader =  DataLoader(train_set, batch_size=batch_size, shuffle=True)
    test_set = ReadData.DukeSpecializedDataset(root_dir, label_dir, task_list[0], task_list[1], 'test', data_transform)
    test_dataloader =  DataLoader(test_set, batch_size=batch_size, shuffle=True)
    validation_set_2 = ReadData.DukeSpecializedDataset(root_dir, label_dir, task_list[0], task_list[1], 'validation_2', data_transform)
    validation_dataloader_2 =  DataLoader(validation_set_2, batch_size=batch_size, shuffle=True)
    validation_set_1 = ReadData.DukeSpecializedDataset(root_dir, label_dir, task_list[0], task_list[1], 'validation_1', data_transform)
...
#要选择哪一个模型来进行任务，就取消注释哪一个模型的部分
    ...
    for task in task_list:
        result['SCMTL']['pair_'+str(pair)+'_'+task] = highest_acc[task]
        df = pd.DataFrame(result)
        df.to_excel('./table/SCMTL_1.xlsx')
        torch.save(model.state_dict(),'./model/SCMTL/SCMTL_1.pth')
        step += 1

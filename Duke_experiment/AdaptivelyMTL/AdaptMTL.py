        ...
        for epoch in range(num_epoches):
            ...
            for i_batch, sample_batched in enumerate(train_dataloader):
                ...
                for task in task_list:
                    ...
                    losses_dict[task] = beta[task]*criterion(outputs, sample_batched['labels'][:,Util.Dukecast2num(task)])
                ...
                with torch.no_grad():
                    ...
                    for task in task_list:
                        ...
                        val_loss_dict[task] = criterion(outputs, validation_batch['labels'][:,Util.Dukecast2num(task)])

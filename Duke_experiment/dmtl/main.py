...
def train_model(task_group, task_list, log_txt, train_dataloader, test_dataloader, device, batch_size=64, num_epoches=30, learning_rate=0.0003):
    criterion = torch.nn.BCELoss()
    model = Networks.DMTL(task_group)
...
#dmtl_model,_,__ = train_model(task_group, task_list, '../log/test.txt', train_dataloader, test_dataloader)